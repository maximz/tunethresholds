#!/usr/bin/env python
#
# tunethresholds documentation build configuration file, created by sphinx-quickstart.
#
...
version = tunethresholds.__version__
# The full version, including alpha/beta/rc tags.
release = tunethresholds.__version__
...
def linkcode_resolve(domain, info):
    def find_source():
        ...
        fn = os.path.relpath(fn, start=os.path.dirname(tunethresholds.__file__))
    ...
    if domain != "py" or not info["module"]:
        return None
    try:
        filename = "tunethresholds/%s#L%d-L%d" % find_source()
    except Exception:
    ...
    return "https://github.com/maximz/tunethresholds/blob/%s/%s" % (tag, filename)
...
htmlhelp_basename = "tunethresholdsdoc"
